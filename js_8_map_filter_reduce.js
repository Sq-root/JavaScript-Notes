...
//Age above 40
const userName = users.filter(userdata => userdata.age > 40).map(x=>x.firstName+" "+x.lastName)
console.log(userName)  //will get only those obj.

//Age < 30
const userName = users.filter(userdata => userdata.age < 40).map(x=>x.firstName)
console.log(userName)  //will get only those obj.